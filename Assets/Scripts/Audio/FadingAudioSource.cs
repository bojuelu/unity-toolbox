// Refrence: http://wiki.unity3d.com/index.php/Fading_Audio_Source
using UnityEngine;
...
public class FadingAudioSource : MonoBehaviour
{
    ...
    /// </summary>
    private float nextClipVolume = 1f;
    ...
    /// </summary>
    public void Play() // it is more like "Resume"
    {
    ...
    /// </summary>
    public void Stop() // it is more like "Pause"
    {
    ...
    /// <summary>
    /// Fade out the audio current playing.
    /// </summary>
    public void StopWithFade()
    {
        this.fadeState = FadeState.FadingOver;
    }
    ...
    private void Update()
    {
        ...
        else if (this.fadeState == FadeState.FadingOver)
        {
            if (this.audioSource.volume > this.FadeOutThreshold)
            {
                // Fade out current clip.
